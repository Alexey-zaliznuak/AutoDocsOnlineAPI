...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='RecordTemplateValue', to='documents.TemplateValue'),
        ),
        migrations.AddField(
            model_name='record',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='documents.documentpackage')),
            ],
            options={
