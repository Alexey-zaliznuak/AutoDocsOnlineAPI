# Generated by Django 3.2 on 2023-08-04 19:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('creation_date', models.DateTimeField(auto_now_add=True, verbose_name='Date of creation')),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('document_package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='records', to='documents.documentspackage')),
            ],
            options={
                'verbose_name': 'Record',
